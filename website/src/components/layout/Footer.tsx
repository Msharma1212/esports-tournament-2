  ...
  return (
    <footer className="relative z-10 overflow-hidden bg-[#0c0c0e]">
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, #f97316 20%, #f97316 80%, transparent)",
          opacity: 0.9,
        }}
      />
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm text-stone-400">{brand.tagline}</p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="#about" className="text-sm text-stone-400 transition hover:text-orange-400">
                  About
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#download" className="text-sm text-stone-400 transition hover:text-orange-400">
                  Start Playing
                </Link>
              </li>
              <li>
          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                <span className="font-ultimatum text-sm font-bold text-orange-500/80">
                  {ref.label}
                </span>
              </a>
            );
