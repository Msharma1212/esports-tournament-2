    ...
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-black/70 backdrop-blur-xl backdrop-saturate-150">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6 sm:py-4 lg:px-8">
        <Link href="/" className="flex items-center gap-3 text-white">
          <span className="flex h-10 w-10 items-center justify-center rounded-full border border-orange-400/50 bg-orange-500/15 font-ultimatum text-sm tracking-[0.25em] text-orange-300">
            XP
          </span>
          <span>
        ...
        <nav className="flex items-center gap-2 sm:gap-4 lg:gap-6">
          ...
          {brand.social.instagram && (
            <a
              ...
              className="flex h-4 w-4 shrink-0 items-center justify-center text-gray-400 transition hover:text-white sm:h-5 sm:w-5"
          ...
          {brand.social.youtube && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-5 w-5 shrink-0 items-center justify-center text-gray-400 transition hover:text-white sm:h-6 sm:w-6"
              aria-label="YouTube"
            >
              <svg
                className="h-full w-full"
